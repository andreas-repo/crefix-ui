...
export class MeasurementThreeFrameComponent {
  tab_label : string = 'Dritter Messpunkt';
  ...
  async saveMeasurementThreeData() {
    ...
    await this.router.navigate(['/measurement-three-image-frame', this.id]);
  }

  returnOnePage() {
    this.router.navigate(['/measurement-two-image-frame', this.id]);
  }
}
