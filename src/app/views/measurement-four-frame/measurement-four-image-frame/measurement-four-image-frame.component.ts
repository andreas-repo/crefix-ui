...
@Component({
  selector: 'app-measurement-four-image-frame',
  imports: [
    CameraComponent
  ],
  templateUrl: './measurement-four-image-frame.component.html',
  styleUrl: './measurement-four-image-frame.component.css'
})
export class MeasurementFourImageFrameComponent {
  ...
  returnOnePage() {
    this.router.navigate(['/measurement-four-frame', this.measurement_id]);
  }
